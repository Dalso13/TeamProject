...
public class ManagerItemController {
	...
	public ResponseEntity<AttachFileDTO> uploadAjaxPost(MultipartFile[] uploadFile) {
		...
		String uploadFolder = "C:\\dev\\workspace\\workspace_spring\\worldFinder\\src\\main\\webapp\\resources\\img";
   	...
   	public String realItemInsert(ItemVO ivo) {
	...
	public String updateItem(ItemVO ivo) {
	...
	public String toKakaoPay(UserOrderVO uovo) {
